            ...
            <FlatList
                ...
                renderItem={({item})=>(
                    <View>
                        ...
                        <TouchableOpacity onPress={() => removeBook(item.id)} style={{backgroundColor:"skyblue",borderStyle:"solid", borderWidth:1}}>
                            <Text style={{ textAlign:"center", color:"white"}}>ลบ</Text>
                        </TouchableOpacity>
                    </View>
                )}
            />
